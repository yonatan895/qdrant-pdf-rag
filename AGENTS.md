...
- Local 8GB co-residency: reasoning port 8000 `GPU_MEM=0.55`; embedding port 8001 `GPU_MEM=0.48 MAX_LEN=4096`; solo reasoning `GPU_MEM=0.85`. Do not restore 0.65/0.30: vLLM V1 refused KV-cache allocation with ValueError at 0.65+0.30 with 4096 on this card.
