...
def build(
    ...
    """Build the IBM-shaped fixture. doc_id/title are parameterized so the
    simulation tier can build a second, distinct document; the defaults keep
    the classic fixture unchanged."""
